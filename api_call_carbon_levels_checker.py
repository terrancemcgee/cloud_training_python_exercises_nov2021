# source: https://www.w3resource.com/projects/python/web-programming/python-web-programming-1.php
...
async def fetch_last_half_hour()  -> str:
    last_half_hour = await requests.get(BASE_URL).json()["data"][0]
